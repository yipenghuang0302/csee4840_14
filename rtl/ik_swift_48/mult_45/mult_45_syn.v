...
//lpm_mult DEVICE_FAMILY="Cyclone V" LPM_PIPELINE=3 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=45 LPM_WIDTHB=45 LPM_WIDTHP=90 MAXIMIZE_SPEED=1 clken clock dataa datab result
...
`endif
	...
	reg	[44:0]	dataa_input_reg;
	reg	[44:0]	datab_input_reg;
	reg	[89:0]	result_output_reg;
	reg	[89:0]	result_extra0_reg;
	wire	signed	[44:0]	dataa_wire;
	wire	signed	[44:0]	datab_wire;
	wire	signed	[89:0]	result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		 if (clken == 1'b1)	result_extra0_reg <= result_wire[89:0];
...
module mult_45 (
	...
	mult_45_mult	mult_45_mult_component (
				.clock (clock),
				.datab (datab),
				.clken (clken),
				.dataa (dataa),
