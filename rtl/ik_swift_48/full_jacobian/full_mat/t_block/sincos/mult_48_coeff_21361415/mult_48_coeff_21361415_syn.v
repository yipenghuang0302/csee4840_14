...
//lpm_mult DEVICE_FAMILY="Cyclone V" INPUT_B_IS_CONSTANT="YES" LPM_PIPELINE=3 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=48 LPM_WIDTHB=48 LPM_WIDTHP=96 MAXIMIZE_SPEED=1 clken clock dataa datab result
...
module  mult_48_coeff_21361415_mult
	( 
	clken,
	clock,
	dataa,
...
endmodule //mult_48_coeff_21361415_mult
//VALID FILE
...
module mult_48_coeff_21361415 (
	...
	mult_48_coeff_21361415_mult	mult_48_coeff_21361415_mult_component (
				.clock (clock),
				.datab (sub_wire1),
				.clken (clken),
				.dataa (dataa),
