...
//lpm_mult DEVICE_FAMILY="Cyclone V" INPUT_B_IS_CONSTANT="YES" LPM_PIPELINE=3 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=36 LPM_WIDTHB=36 LPM_WIDTHP=72 MAXIMIZE_SPEED=1 clken clock dataa datab result
...
module  mult_36_coeff_14746_mult
	( 
	clken,
	clock,
	dataa,
...
endmodule //mult_36_coeff_14746_mult
//VALID FILE
...
module mult_36_coeff_14746 (
	...
	mult_36_coeff_14746_mult	mult_36_coeff_14746_mult_component (
				.clock (clock),
				.datab (sub_wire1),
				.clken (clken),
				.dataa (dataa),
...
// Retrieval info: CONNECT: @datab 0 0 36 0 14746 0 0 36 0
